...
class VehicleSpeedChart extends StatefulWidget {
  final List<double> speedData;
  final List<String> timeLabels;
  final bool isDark;

  const VehicleSpeedChart({
    super.key,
  ...
  @override
  State<VehicleSpeedChart> createState() => _VehicleSpeedChartState();
}

class _VehicleSpeedChartState extends State<VehicleSpeedChart> {
  int? touchedIndex;
  double? touchedY;
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: Stack(
        children: [
          LineChart(_buildSpeedChartData(widget.isDark)),
            ...
            IgnorePointer(
              ...
              child: CustomPaint(
                ...
                painter: CrosshairPainter(
                  xIndex: touchedIndex!,
                  yValue: touchedY!,
                  totalPoints: widget.speedData.length,
  ...
  LineChartData _buildSpeedChartData(bool isDark) {
...
class CrosshairPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Normalize y position based on the chart height
